...
- At klubbens eget webkamera og «Bodø-vinden»-panelet vises riktig på forsiden uten vær-iframe, rullefelt eller unødvendig tomrom.
- At Bestemorenga og Keiservarden er merket som **prognose**, mens Bodø lufthavn er merket som **målt referanse**.
- At alle tre radene viser vind i m/s, temperatur, vindretning, tidspunkt og vindkast når kilden leverer det, og at eldre reserveverdier merkes tydelig.
...
- Kontroller at værdata hentes server-side uten at nettleseren oppretter en direkte forbindelse til MET eller AviationWeather.gov. De frivillige kildelenkene skal fortsatt åpne eksternt.
