...
<main id="main-content">
	<section class="hero" aria-label="Bodø Modellflyklubb">
		<img class="hero-banner" src="<?php echo esc_url( bmfk_asset_url( 'images/bmfk-hero.webp' ) ); ?>" alt="Bodø Modellflyklubb ved modellflyplassen på Bestemorenga" width="2033" height="774" fetchpriority="high">
	</section>

	<nav class="quick-actions" aria-label="Snarveier">
		...
		<div class="wrap intro-grid">
			<div class="intro-copy">
				...
				<div class="button-row">
					<a class="button button--orange" href="<?php echo esc_url( $membership_url ); ?>">Jeg vil bli medlem <span aria-hidden="true">→</span></a>
			...
			<div class="field-panel">
				<div class="field-copy">
					...
					<div class="hours-grid" role="group" aria-label="Banens åpningstider">
						<div class="hours-card"><small>Elektromotor</small><strong><?php echo esc_html( bmfk_setting( 'bmfk_electric_hours', 'Hele døgnet' ) ); ?></strong></div>
						<div class="hours-card"><small>Forbrenningsmotor</small><strong><?php echo esc_html( bmfk_setting( 'bmfk_combustion_hours', '09:00–21:00' ) ); ?></strong></div>
					</div>
					<div class="button-row">
						<a class="button button--orange" href="<?php echo esc_url( $webcam_url ); ?>">Åpne webkamera</a>
						<a class="button" href="<?php echo esc_url( $rules_url ); ?>">Les reglene</a>
					</div>
				</div>
		...
		<div class="wrap">
			...
			<div class="safety-grid">
				...
				<article class="safety-card">
					...
					<a href="https://nlf.no/siteassets/modellfly/sikkerhet-og-utdanning/modellflyhandboka/modellflyhandboka/modellflyhandboka-v-2.2---01.06-2025.pdf">Se gjeldende håndbok <span aria-hidden="true">→</span></a>
				</article>
				<article class="safety-card">
	...
	<section class="gallery-section" aria-labelledby="gallery-title">
		<div class="wrap">
			...
			<section class="gallery-grid" aria-label="Bildegalleri fra modellflyplassen" tabindex="0">
				<figure class="gallery-item"><img src="<?php echo esc_url( bmfk_asset_url( 'images/gallery-aircraft.webp' ) ); ?>" alt="Modellfly klare på bakken" width="1200" height="800" loading="lazy"><figcaption>Klar for neste tur</figcaption></figure>
				<figure class="gallery-item"><img src="<?php echo esc_url( bmfk_asset_url( 'images/gallery-fpv.webp' ) ); ?>" alt="FPV-pilot med radiostyrt quad" width="1200" height="800" loading="lazy"><figcaption>FPV og multirotor</figcaption></figure>
				<figure class="gallery-item"><img src="<?php echo esc_url( bmfk_asset_url( 'images/gallery-helicopter.webp' ) ); ?>" alt="Radiostyrt helikopter over banen" width="1200" height="800" loading="lazy"><figcaption>Helikopterflyging</figcaption></figure>
	...
	<section class="join-section">
		<div class="wrap">
			<div class="join-panel">
				...
				<div class="button-row"><a class="button button--orange" href="<?php echo esc_url( $membership_url ); ?>">Bli medlem nå <span aria-hidden="true">→</span></a></div>
			</div>
		</div>
	</section>
</main>
