...
<header class="site-header" data-site-header>
	<div class="header-inner wrap">
		<a class="site-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php esc_attr_e( 'Bodø Modellflyklubb – forsiden', 'bmfk' ); ?>">
			<img class="site-brand__logo" src="<?php echo esc_url( bmfk_asset_url( 'images/bmfk-logo.webp' ) ); ?>" alt="" width="54" height="54">
			<span>
		...
		<a class="header-cta" href="<?php echo esc_url( bmfk_setting( 'bmfk_membership_url', 'https://blimedlem.bodomfk.no/' ) ); ?>">Bli medlem</a>
